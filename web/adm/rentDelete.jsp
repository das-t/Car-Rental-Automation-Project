<%-- 
    Document   : rentDelete.jsp
    Created on : 23 Oct, 2016, 9:33:02 AM
    Author     : tisan
--%>

<%@page import="contoller.AdminRent"%>
...
<html>
    ...
    <body>
        ...
        <%
            int rentId = Integer.parseInt(request.getParameter("delete"));
            String message = "Failure!";
            boolean bool = admin.deleteRent(rentId);
            if(!bool){
                message = "Success!";
            }
