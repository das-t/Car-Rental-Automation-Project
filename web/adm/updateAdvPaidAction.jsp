<%-- 
    Document   : updateAdvPaidAction
    Created on : 23 Oct, 2016, 5:06:06 PM
    Author     : tisan
--%>
...
<html>
    <head>
        ...
        <title>Advance Paid Advance</title>
    </head>
    <body>
        <h1><br/></h1>
        ...
        <%
            ...
            boolean bool = admin.updateAdvancePayment(rentId);
            if(!bool){
                message = "Advance Paid!";
            }
        %>
